...
import { FileText, Eye, Edit3, Download, RefreshCw, Clock, AlertCircle, Plus } from 'lucide-react';

const FileTracker = ({ files, onViewFile, onEditFile, isVisible }) => {
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="font-semibold text-white">Files in Chat</h3>
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {files.length === 0 ? (
          <div className="text-center text-gray-400 mt-8">
            ...
            <p className="text-xs">Upload files to track them here</p>
          </div>
        ) : (
